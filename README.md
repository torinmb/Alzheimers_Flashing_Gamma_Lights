...
Insipred by the Radio Lab podcast http://www.radiolab.org/story/bringing-gamma-back/ showcasing a potential treatment to Alzheimers.
...
Attach the LED strip to the Arduino. Attach the middle pin of the LED strip to pin 6 on the Arduino.  Upload the arduino library 
